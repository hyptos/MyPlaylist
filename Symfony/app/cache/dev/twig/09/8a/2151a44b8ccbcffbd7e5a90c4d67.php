...
class __TwigTemplate_098a2151a44b8ccbcffbd7e5a90c4d67 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_7565997a4da1aa255fe0bd2baca2717eb8f5cdc2"] = $this;
        // line 5
...
";
    ...
    ";
        // line 82
        echo $context["__internal_7565997a4da1aa255fe0bd2baca2717eb8f5cdc2"]->getdisplay_timeline(("timeline_" . $this->getContext($context, "token")), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getContext($context, "colors"));
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "children"))) {
            ...
            ";
                // line 92
                echo $context["__internal_7565997a4da1aa255fe0bd2baca2717eb8f5cdc2"]->getdisplay_timeline(("timeline_" . $this->getAttribute($this->getContext($context, "child"), "token")), $this->getContext($context, "events"), $this->getContext($context, "colors"));
                echo "
        ";
            }
...
";
    ...
    public function getdump_request_data($token = null, $profile = null, $events = null, $origin = null)
    {
        ...
        try {
            // line 432
            $context["__internal_5a3ab206f7db4d2604f7888e504f71e8db5525ce"] = $this;
            // line 433
            echo "                {
                    \"id\": \"";
            // line 434
...
";
            // line 437
            echo $context["__internal_5a3ab206f7db4d2604f7888e504f71e8db5525ce"]->getdump_events($this->getContext($context, "events"));
            echo "
                    ]
                }
";
